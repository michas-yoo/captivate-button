define(function(require) {
    ...
    var TheButton = ComponentView.extend({
        ...
        inview: function(event, visible, visiblePartX, visiblePartY) {
            if (visible) {
                ...
                $("body").append(`<script>${$(".Button-instruction-inner").text()}</script>`);
                $(".Button-instruction-inner").remove();
            }
        },
    ...
    Adapt.register('Button', TheButton);
